...
public class EvaluateRestrictedAuthenticator implements Authenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        log.info("Starting enrollment evaluation of restricted login process");
        EnrollmentServiceProvider enrollmentServiceProvider = context.getSession().getProvider(EnrollmentServiceProvider.class);
        enrollmentServiceProvider.callEvaluateLimitedService(context.getUser());
        context.success();
