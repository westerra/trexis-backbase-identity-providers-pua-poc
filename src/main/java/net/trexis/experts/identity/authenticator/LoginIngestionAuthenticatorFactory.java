...
public class LoginIngestionAuthenticatorFactory implements AuthenticatorFactory {

    @Override
    public Authenticator create(KeycloakSession session) {
        return new LoginIngestionAuthenticator();
    }
    ...
    public String getHelpText() {
        return "Void Authenticator used to trigger ingestion process";
    }
    ...
    public String getDisplayType() {
        return "Login Ingestion Authenticator";
    }
